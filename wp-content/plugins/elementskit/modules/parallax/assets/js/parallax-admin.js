                ...
                ! function(e, t) {
                    ...
                    var i = function(n) {
                        var i = this,
                            ...
                            s = e(window);
                        e("body"), s.scrollTop(), s.height(), navigator.userAgent.match(/Version\/[\d\.]+.*Safari/), navigator.platform;
                        i.init = function() {
                            return i.setParallaxMulti(o), i.moveBg(o), !1
                        }, i.setParallaxMulti = function(t) {
                            var o, s = {},
                                r = [];
                            if (s = i.getOptions(t, "ekit_section_parallax_multi_items"), "yes" == (o = i.getOptions(t, "ekit_section_parallax_multi"))) {
                                if (a) {
                                    if (!s.hasOwnProperty("models") || 0 === Object.keys(s.models).length || "yes" != o) return;
                                    s = s.models
                                }
                                if (n.addClass("elementskit-parallax-multi-container"), e.each(s, (function(e, t) {
                            ...
                            var t = i.getOptions(e, "ekit_section_parallax_bg"),
                                o = i.getOptions(e, "ekit_section_parallax_bg_speed") || .2,
                                s = i.getOptions(e, "elementor_lazy_load");
                            if ("yes" !== t || n.hasClass("elementskit-parallax-multi-container")) return;
                            const r = () => {
                                n.addClass("elementskit-parallax-multi-container"), a || ("function" == typeof n.jarallax ? n.jarallax({
                                    speed: o
                            ...
                            if ("1" == s) {
                                new IntersectionObserver(((e, t) => {
                                    e.forEach((e => {
                                        if (e.isIntersecting) {
                                            const n = e.target.classList.contains("e-lazyloaded"),
                                                i = "none" !== window.getComputedStyle(e.target).backgroundImage;
                                            if (n || i) setTimeout((() => {
                                                r()
                                            }), 100), t.unobserve(e.target);
                                            else {
                                                const n = new MutationObserver((i => {
                                                    i.forEach((i => {
                                                        i.target.classList.contains("e-lazyloaded") && (setTimeout((() => {
                                                            r()
                                                        }), 100), n.disconnect(), t.unobserve(e.target))
                                                    }))
                                                }));
                                                n.observe(e.target, {
                                                    attributes: !0,
                            ...
                            var i = t.pageX - n.offset().left,
                                ...
                                a = n.find(".elementor-repeater-item-" + e._id);
                            TweenMax.to(a, 1, {
                            ...
                            if (a) {
                                ...
                                if (void 0 === (o = e(t = ".elementor-element-" + t).data("ekitparallax"))) return;
                            ...
                            var a = i.escapeString(t),
                                s = i.escapeString(e.parallax_style),
                                r = i.escapeString(o),
                                l = i.escapeString(e.image.url),
                                c = i.escapeString(e.image.alt);
                    ...
                    var i = "undefined" != typeof window.elementorFrontend.version && function(e, t) {
                        ...
                        o = i.extend({
                            ...
                            mousemove: function() {
                                ...
                                t.on("mousemove.elementskitwidgethovereffect", (function(i) {
                                    var o = i.pageX - t.offset().left,
                                        a = i.pageY - t.offset().top;
                                    TweenMax.to(e, 1, {
                                        x: (o - t.width() / 2) / t.width() * n,
                                        y: (a - t.height() / 2) / t.height() * n,
                                        ease: Power2.ease
                                    })
                                }))
                            },
                            ...
                            contentElementFinder: function() {
                                ...
                                return 0 === e.length && (e = this.$element), e
                            }
                        })
                }(jQuery, window.elementorFrontend)
            }
